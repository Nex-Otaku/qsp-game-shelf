 ...
 * добавляем модуль "user" в список "bootstrap".
 * При загрузке приложения, будет вызван метод "bootstrap" класса "UserBaseModule", 
 * в этом методе будет переопределён путь к классу Finder.
 * 
 * TODO:
